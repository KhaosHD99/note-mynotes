 ...
 */
static GtkIconSize get_largest_size(const char *id)
{
...
static void id_set_func(GtkTreeViewColumn *tree_column,
           						  GtkCellRenderer   *cell,
           						  GtkTreeModel      *model,
					              GtkTreeIter       *iter,
					              gpointer           data)
...
static void label_set_func (GtkTreeViewColumn *tree_column,
						                GtkCellRenderer   *cell,
						                GtkTreeModel      *model,
						                GtkTreeIter       *iter,
						                gpointer           data)
...
int main(int argc, char *argv[])
{
		...
		if(!window)
	  {
		    ...
		    display->icon_image = gtk_image_new_from_pixbuf (NULL);
