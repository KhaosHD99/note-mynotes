echo "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
echo "集体调试的编译脚本,程序或库将运行在/usr/Fn/debug"
echo "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
...
export PKG_CONFIG_PATH=$SDKDIR_USR/$DEBUG/lib/pkgconfig:$SDKDIR_USR/$RELEASE/lib/pkgconfig:$SDKDIR_USR/lib/pkgconfig:$SDKDIR/lib/pkgconfig:$SDKDIR_USR/share/pkgconfig
